...
INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 ...
 VALUES ("AU35", 'B', "CRUNCH 9", 59, 41, "4X12 B 1" );
    ...
    INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU36", 'A', "STACK 8", 75, 61, "NO CAB" );
 
    INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU36", 'B', "STACK 8", 75, 61, "NO CAB" );
 
  INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU37", 'A', "RECTIF 3", 99, 65, "4X12 V 1" );
 
  INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU37", 'B', "FUZZ 11", 84, 53, "4X12 V 2" );
 
   INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU38", 'A', "STACK 8", 99, 63, "4X12 B 1" );
 
   INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU38", 'B', "RECTIF 3", 80, 92, "4X12 V 2" );
 
    INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU39", 'A', "STACK 8", 99, 59, "2X12 O 1" );
 
    INSERT INTO Amp_Model_Cab_Options(ID, AMP_CHANNEL, AMP_TYPE, GAIN, AMP_LEVEL, CABINET_MIC)
 VALUES ("AU39", 'B', "HOTROD 4", 99, 30, "4X12 G 1" );